...
1. [Overview](#overview)
2. [Nextion .txt File Structure](#nextion-txt-file-structure)
   - [File Header](#file-header)
   - [Component Types](#component-types)
   - [Hotspot Components](#hotspot-components)
...
3. [Known Issues](#known-issues)
   - [Code Bugs](#code-bugs)
   - [Screen Text Issues](#screen-text-issues)
   - [Non-Functional Screens](#non-functional-screens)
4. [Screen Map](#screen-map)
5. [Main Screen](#main-screen)
   - [Layout](#layout)
   - [Navigation](#navigation)
   - [Live Updates](#live-updates)
   - [Buttons](#buttons)
6. [File Browser Screens](#file-browser-screens)
7. [Print Pause / Resume Screen](#print-pause--resume-screen)
   - [States](#states)
   - [Buttons](#buttons-1)
   - [Pause Flow](#pause-flow)
   - [Resume Flow](#resume-flow)
   - [M600 Filament Change Resume](#m600-filament-change-resume)
   - [Power Loss Recovery Resume](#power-loss-recovery-resume)
   - [Confirmation Dialogs](#confirmation-dialogs)
8. [Temperature Adjustment Screen](#temperature-adjustment-screen)
   - [Layout](#layout-1)
   - [Controls](#controls)
   - [Sub-pages](#sub-pages)
   - [Buttons](#buttons-2)
9. [Speed/Flow Adjustment](#speedflow-adjustment)
   - [Controls](#controls-1)
   - [Buttons](#buttons-3)
10. [Z-Offset Adjustment](#z-offset-adjustment)
    - [Controls](#controls-2)
    - [Buttons](#buttons-4)
11. [Settings Screen](#settings-screen)
    - [Menu Items](#menu-items)
    - [PLR Icon](#plr-icon)
    - [Multifile Display](#multifile-display)
    - [Buttons](#buttons-5)
    - [Model Detection](#model-detection)
12. [Language Screen](#language-screen)
    - [Languages](#languages)
    - [Buttons](#buttons-6)
13. [Machine Info Screen](#machine-info-screen)
    - [Displayed Info](#displayed-info)
14. [LED Control Screen](#led-control-screen)
    - [Controls](#controls-3)
    - [Buttons](#buttons-7)
15. [Bed Leveling Screens](#bed-leveling-screens)
    - [leveling.txt](#levelingtxt)
    - [leveldata.txt](#leveldatatxt)
    - [Buttons](#buttons-8)
    - [Leveling Mesh Screens](#leveling-mesh-screens)
16. [Boot Screen](#boot-screen)
    - [Flow](#flow)
    - [Picture Preview](#picture-preview)
17. [Wait Screen](#wait-screen)
    - [Purpose](#purpose)
    - [Buttons](#buttons-9)
18. [Filament Screens](#filament-screens)
    - [prefilament.txt](#prefilamenttxt)
    - [heatfilament.txt](#heatfilamenttxt)
    - [nofilament.txt](#nofilamenttxt)
    - [filamentresume.txt](#filamentresume.txt)
    - [Buttons](#buttons-10)
    - [Filament Pre-screen](#filament-pre-screen)
    - [Temperature Set Screens](#temperature-set-screens)
19. [Error Screens](#error-screens)
    - [Error Screen Keys](#error-screen-keys)
20. [Hardware Test Screen](#hardware-test-screen)
    - [Tests](#tests)
    - [Buttons](#buttons-11)
21. [Key State Variables](#key-state-variables)
22. [Update Cycle](#update-cycle)
23. [G-Code Commands Used](#g-code-commands-used)
24. [Icon Reference](#icon-reference)
25. [Variable Address Reference (VP)](#variable-address-reference-vp)
26. [Key Actions Reference](#key-actions-reference)
